...
public class HeroAdapter extends RecyclerView.Adapter<HeroAdapter.HeroViewHolder> {
    ...
    public void onBindViewHolder(final HeroViewHolder holder, final int position) {
        ...
        holder.textViewRealName.setText(hero.getCapital());
        holder.textViewTeam.setText(hero.getRegion());
        holder.textViewFirstAppearance.setText(hero.getSubregion());
        holder.textViewCreatedBy.setText(hero.getPopulation());
        holder.textViewPublisher.setText(hero.getBorders());
        holder.textViewBio.setText(hero.getLanguages().trim());

        Glide.with(context).load(hero.getFlag()).into(holder.imageView);
